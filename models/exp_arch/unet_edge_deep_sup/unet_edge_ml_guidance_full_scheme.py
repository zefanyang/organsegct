...
# @Author: yzf
"""Full scheme for multi-level guidance. Final layer no edge guidance"""
import os
import torch
...
if __name__ == '__main__':
 model = UNetEdgeMLGdnFullSch(1, 9, init_ch=16, conv_layer_order='cbr', interpolate=True)
