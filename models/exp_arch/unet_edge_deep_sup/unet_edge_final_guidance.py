...
class UNetEdgeFnlGd(nn.Module):
    ...
    def forward(self, x):
        ...
        # final guidance
        fnl_feat = self.fnl_trans(edge_feat)
        fnl_feat = F.interpolate(fnl_feat, scale_factor=2, mode='trilinear')
        fnl_feat = dec1 + fnl_feat
...
if __name__ == '__main__':
 model = UNetEdgeFnlGd(1, 9, init_ch=16, conv_layer_order='cbr', interpolate=True)
