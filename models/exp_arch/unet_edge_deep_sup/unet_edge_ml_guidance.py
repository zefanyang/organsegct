...
class UNetEdgeMLGdn(nn.Module):
    ...
    def forward(self, x):
        ...
        fnl_score = self.final_conv(fnl_feat)
...
if __name__ == '__main__':
 model = UNetEdgeMLGdn(1, 9, init_ch=16, conv_layer_order='cbr', interpolate=True)
