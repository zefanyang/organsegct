...
# @Author: yzf
"""
V-Net with 5*5*5 convolutional kernels.
...
class OutputTransition(nn.Module):
    def __init__(self, inChans, elu, nll):
        ...
        self.conv1 = nn.Conv3d(inChans, 9, kernel_size=5, padding=2)
...
class VNet(nn.Module):
    ...
    # https://github.com/faustomilletari/VNet/tree/master/Prototxt
