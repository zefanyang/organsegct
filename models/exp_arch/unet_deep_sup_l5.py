...
# @Author: yzf
"""9-layer UNet with deep supervision"""
...
if __name__ == '__main__':
    ...
    model = UNetDeepSupL5(1, 9, init_ch=16, conv_layer_order='cbr', interpolate=True)
