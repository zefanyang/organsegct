...
class EGModule(nn.Module):
    def __init__(self, init_ch):
        ...
        # 3*3*3 convolution to concentrate the channel
        ...
        # dilated convolution could be a better choice
...
if __name__ == '__main__':
 model = UNetEdgeTransKnl3(1, 9, init_ch=16, conv_layer_order='cbr', interpolate=True)
