...
class EGModule(nn.Module):
    def __init__(self, init_ch):
        ...
        self.e_conv = nn.Sequential(
            nn.Conv3d(init_ch * 2, init_ch * 2, 3, 1, 2, 2),
            nn.BatchNorm3d(init_ch * 2),
            nn.ReLU(),
            nn.Conv3d(init_ch * 2, init_ch * 2, 3, 1, 2, 2),
            nn.BatchNorm3d(init_ch * 2),
...
if __name__ == '__main__':
 model = UNetEdgeDltConv(1, 9, init_ch=16, conv_layer_order='cbr', interpolate=True)
