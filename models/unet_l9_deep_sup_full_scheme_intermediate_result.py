...
class UNetL9DeepSupFullScheme(nn.Module):
    ...
    def forward(self, x):
        ...
        return seg_score, rfp_seg_score, comb_seg_score, edge_score, (dsup4, dsup3, dsup2, dsup1)
...
if __name__ == '__main__':
    ...
    model = UNetL9DeepSupFullScheme(1, 9, init_ch=16, conv_layer_order='cbr', interpolate=True)
