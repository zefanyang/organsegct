...
class UNetL9DeepSupFullScheme_ESCs(nn.Module):
    def __init__(self, in_ch, out_ch, no_escs=4, dsup=True, num_neigh='four', interpolate=True, init_ch=16, conv_layer_order='cbr'):
        super(UNetL9DeepSupFullScheme_ESCs, self).__init__()

        self.no_class = out_ch
        self.no_escs = no_escs
        self.dsup = dsup
        ...
        # deep supervision
            ...
            self.final_conv = nn.Conv3d(init_ch, self.no_class, 1)
...
if __name__ == '__main__':
    ...
    model = UNetL9DeepSupFullScheme_ESCs(1, 9, no_escs=2, dsup=False, init_ch=16, conv_layer_order='cbr', interpolate=True)
