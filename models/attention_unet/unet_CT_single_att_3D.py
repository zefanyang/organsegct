...
import torch
from models.attention_unet.utils import UnetConv3, UnetUp3_CT, UnetGridGatingSignal3, UnetDsv3
import torch.nn.functional as F
from models.attention_unet.networks_other import init_weights
from models.attention_unet.grid_attention_layer import GridAttentionBlock3D


class unet_CT_single_att_3D(nn.Module):
    ...
    def __init__(self, feature_scale=4, n_classes=21, is_deconv=True, in_channels=3,
        ...
        super(unet_CT_single_att_3D, self).__init__()
        ...
        filters = [int(x / self.feature_scale) for x in filters]  # filters = [16, 32, 64, 128, 256]
...
if __name__ == '__main__':
    ...
    model = unet_CT_single_att_3D(n_classes=9, in_channels=1)
