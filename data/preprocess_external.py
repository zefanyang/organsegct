...
outpath = '/data/yzf/dataset/organct/external/preprocessedval'
namesval = os.listdir(os.path.join(basepath, 'imagesVal'))
...
if __name__ == '__main__':
    # Resample images
    for name in namesval:
        imgpath = os.path.join(basepath, 'imagesVal', name)
        labpath = os.path.join(basepath, 'labelsVal', name)
